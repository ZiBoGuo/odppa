...
HD_PWD='F:/DNN_IP/DNNv4/dnn_690t/dnn_690t.runs/bram32_512_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram32_512.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram32_512.tcl
