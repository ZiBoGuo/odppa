...
HD_PWD='/home/hht/gzb/DNN330/ppa/pp717/dnn_690t/dnn_690t.runs/impl_4'
cd "$HD_PWD"
...
EAStep vivado -log yolo_layer_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source yolo_layer_top.tcl -notrace
