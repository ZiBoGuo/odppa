...
HD_PWD='F:/DNN_IP/DNNv4/dnn_690t/dnn_690t.runs/div_gen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log div_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source div_gen.tcl
