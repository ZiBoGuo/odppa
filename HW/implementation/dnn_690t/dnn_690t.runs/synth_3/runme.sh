...
HD_PWD='/home/hht/gzb/DNN330/ppa/pp717/dnn_690t/dnn_690t.runs/synth_3'
cd "$HD_PWD"
...
EAStep vivado -log yolo_layer_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source yolo_layer_top.tcl
