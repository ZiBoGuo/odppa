...
#
# Generated by export_simulation on Tue Jul 11 16:16:19 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './ExpROM.sh' script.
...
./ExpROM.sh -noclean_files

For more information on the script, please type './ExpROM.sh -help'.
