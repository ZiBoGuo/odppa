...
#
# Generated by export_simulation on Fri Jun 30 20:02:24 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './bram32_512.sh' script.

./bram32_512.sh -reset_run
...
./bram32_512.sh -noclean_files

For more information on the script, please type './bram32_512.sh -help'.
