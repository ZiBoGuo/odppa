...
#
# Generated by export_simulation on Fri Jun 30 21:53:06 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './div_gen.sh' script.

./div_gen.sh -reset_run
...
./div_gen.sh -noclean_files

For more information on the script, please type './div_gen.sh -help'.
